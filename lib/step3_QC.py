...
"""%(str(conf_dict['Mapping_stat']['totalreads']),
    ...
    outf = open(conf_dict['QCplots']['map_summary'])
    ...
    cmd = "intersectBed -a %s -b %s -c > %s"%(conf_dict['General']['outname'] + '_gene_anno_binexon.bed', conf_dict['General']['sampledownbed'],conf_dict['General']['outname']+'_sampledown_on_gbbin.bed' )
